...
//         {message}
//       </div>
//       <CardFooterSessionLog time={time} qualifyingPart={qualifyingPart} />
//     </div>
//   )
// }
...
const DriverWithImageSessionLogs = () => {
  return <div>DriverWithImageSessionLogs</div>
}
export default DriverWithImageSessionLogs
